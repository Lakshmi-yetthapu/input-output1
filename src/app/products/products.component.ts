...
export class ProductsComponent implements OnInit {
 ...
 products = [
  ...
  ngOnInit() {
    ...
    this.totalProductsInStock = this.products.filter(p => p.availabilityStatus === 'In Stock').length;
    this.totalProductsOutOfStock = this.products.filter(p => p.availabilityStatus !== 'In Stock').length;
  ...
  isProductAvailable(availabilityStatus: string): boolean {
