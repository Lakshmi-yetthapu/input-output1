...
@Component({
  ...
  imports: [CommonModule, FilterProductsComponent],
...
totalProductsInStock = this.products.filter(p => p.availabilityStatus === 'In Stock').length
totalProductsOutOfStock = this.products.filter(p => p.availabilityStatus !== 'In Stock').length
ngOnInit() {
  console.log(`TotalProducts: ${this.totalProducts}`)
  console.log(`TotalInStockProducts: ${this.totalProductsInStock}`)
  console.log(`TotalOutOfStockProducts: ${this.totalProductsOutOfStock}`)
}
